...
function Header() {
  ...
  return (
    <nav
      className={`${
        isScrolled &&
        "fixed z-40 h-[70px] w-full rounded-lg backdrop-blur-sm transition duration-200 ease-out"
      }`}
      onClick={() => showMobileMenu}
    >
      <div
        className={`${
          showBackground ? "bg-zinc-900/20 bg-opacity-10" : ""
        } flex h-[70px] flex-row items-center transition duration-500 md:px-16`}
      >
        <h1
